...
namespace BaigiamasisDarbas.Page
{
    public class SkytechCartPage : BasePage
    {
        ...
        public SkytechCartPage FindProductAndAddToCart() 
        {
            ...
            Driver.FindElement(By.XPath("/html/body/div[6]/div[1]/div[6]/div[2]/div[3]/div/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr/td/div[1]/div[1]/ul/li[1]/a")).Click();
            ...
            NavigateToDefaultPage();
            IWebElement textCheck = Driver.FindElement(By.XPath("/html/body/div[6]/div[1]/div[6]/div[2]/div[5]/form/div[1]/table[1]/tbody/tr[2]/td[1]"));
